@ECHO OFF
									SET "PHP_PEAR_SYSCONF_DIR=D:\RightSolutions4uWP\php"
...
FOR %%x IN ("D:\RightSolutions4uWP\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\RightSolutions4uWP\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\RightSolutions4uWP\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\RightSolutions4uWP\php\php.exe"
